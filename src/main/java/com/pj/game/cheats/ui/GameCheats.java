...
public final class GameCheats {
    ...
    private void initializeApplication() {
        ...
        Image image = createFrameIcon("/com/pj/game/cheats/images/icon.png");
...
//        frame.pack();
//        MenuNavigationBar menuNavigationBar = new MenuNavigationBar();
//        frame.add(menuNavigationBar.show(), BorderLayout.NORTH);
//        frame.add(centralPanel, BorderLayout.CENTER);
//        frame.setFont(ApplicationFontUtil.font14());
//        Image image = createFrameIcon("/com/pj/game/cheats/images/icon.png");
...
//        tabbedPane.addTab("Walkthrough", gameWalkthrough);
     ...
     * 2.Other rows are for listing individual game cheats.<br/><br/>
     * Has three colomns, first for game Serial Number, second for game genre(like FPS or RPG) and
     * third for Game Title.<br/><br/>
     *
     * <p>If there is no data related to the game in database then it returns null and message.</p>
     * @return JTable
     */
    public JTable getAndShowPcGameListTable() {
        ...
        for (int i = 0; i < gameInformation.size(); i++) {
            ...
            defaultModel.addRow(rowData);
            System.out.println("-> Data no[" + (i + 1) + "] of list is : - " + rowData[1] + " with game id -> " + pcInfoListArray[i + 1]);
        }
...
//        }
    ...
    /**
     * Get the Icon for application that will appear when application is running.
     * @param path(String)
     * @return Image
     */
