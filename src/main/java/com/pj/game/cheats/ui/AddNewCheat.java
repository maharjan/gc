...
public class AddNewCheat extends JPanel {
	...
	public void createAndShowUI() {
		...
		uploadFromTableBtn.setFont(FontUtil.font12());
		uploadFromTableBtn.setPreferredSize(buttonDimension);
		uploadFromTableBtn.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent e) {
//				JXCollapsiblePane collapsiblePane = new JXCollapsiblePane();
//				collapsiblePane.getContentPane().setFont(FontUtil.font14());
//				// to set the background color
//				collapsiblePane.getContentPane().setBackground(Color.gray);
//				collapsiblePane.getContentPane().add(new JXButton("Click here"));
//				collapsiblePane.setPreferredSize(new Dimension(150, 100));
//				collapsiblePane.setVisible(true);
			}
		});

		updateBtn.setFont(FontUtil.font12());
		updateBtn.setSize(buttonDimension);

		clearBtn.setFont(FontUtil.font12());
		clearBtn.setPreferredSize(buttonDimension);

		deleteBtn.setFont(FontUtil.font12());
		...
		// centralPanel.setPreferredSize(new Dimension((int)
		// dimension.getWidth() - 330, (int) dimension.getHeight() - 250));
	...
	public JTable getAndShowAddNewCheatTable() {
		...
		// cheatDisplayTable.setPreferredSize(new Dimension((int)
		// dimension.getWidth() - 250, dimension.height - 150));
		// cheatDisplayTable.setSize(new Dimension((int) dimension.getWidth() -
		// 250, dimension.height - 150));
		addNewCheatTable.setFont(new Font("Bookman Old Style", 0, 14));
		addNewCheatTableScrollPane = new JScrollPane(addNewCheatTable);
		// cheatTableScrollPane.setSize(new Dimension((int) dimension.getWidth()
		// - 250, dimension.height - 150));
